...
<div class="app-mail">
  <div class="header-topcorner bg-neutral-300 px-4 py-2 flex gap-4 text-sm" style="grid-area:topcorner;">
    ...
    <div class="flex flex-col justify-end">
      ...
      <div>
        <router-link :to="{name:'logout'}" class="cursor-pointer mr-4 hover:underline">Sign out</router-link>
  ...
  <div class="sidebar px-4 pt-4 bg-neutral-100" style="grid-area:sidebar;">
    <button v-if="account.policy('messages.send', true)" unstyled class="w-full py-4 mb-8 bg-primary-400" @click="showNewMail=true">New Message</button>
